"""Worker abstraction over the Anthropic Managed Agents API.

The `Worker` protocol is the seam for swapping execution backends later
(local executor, Modal, E2B, OpenAI Assistants, etc.). `ManagedAgentWorker`
is the v1 implementation against Anthropic Managed Agents.
"""
